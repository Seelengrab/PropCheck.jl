...
"""
    check(p, i::AbstractIntegrated[, rng::AbstractRNG=Random.default_rng()];
             ntests::Int=PropCheck.numTest[], show_initial=true)
 ...
 * `show_initial`: Whether to show the initial failiing example in the printed `@info` message
"""
function check(p, i::AbstractIntegrated, rng::AbstractRNG=Random.default_rng();
                  ntests::Int=numTests[], show_initial=true)
